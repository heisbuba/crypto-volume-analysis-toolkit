...
# Get api key from https://coinranking.com/api
        ...
        def generate_html_report(futures_df: pd.DataFrame, spot_df: pd.DataFrame) -> Optional[str]:
            ...
            <body>
                ...
                {html_content}
                  {oiss_explainer_html}
                <div class="footer">
                    <p>Generated by Crypto Volume Analysis Toolkit 3.0 | By (@traderabba)</p>
                </div>
            </body>
            </html>
            """
...
class LogCatcher:
    ...
    def write(self, msg):
        ...
        if msg and msg.strip():
            ...
            elif "processing spot data" in text:
...
<body>
    <div class="container">
        ...
        <p style="text-align:center; color:#848e9c; font-size:0.9rem;">
            Crypto Volume Analysis Toolkit v3.0<br>By @TraderAbba
        </p>
        ...
        <div class="card">
            ...
            <a href="https://github.com/traderabba/Crypto-Volume-Analysis-Toolkit" class="link" target="_blank">GitHub Documentation ↗</a>
        </div>
        ...
        <form action="/save-config" method="POST">
            ...
            <div class="card">
                ...
                <p style="font-size:0.9rem; color:#848e9c; margin-top:9px; margin-bottom:3px;">
                    ...
                    4. Select these Columns: MC, Vol 24H, 24H OI Change %, VTMR (Custom) and tap on Apply<br>
...
<body>
    <div class="container">
        ...
        <div class="card">
            <h2>About Crypto VAT v3.0</h2>
            <p style="font-size:0.9rem; line-height:1.6;">
                <strong>Crypto Volume Analysis Toolkit v3.0</strong><br>
        ...
        <div class="card">
            ...
            <div style="margin-top:15px; display:grid; grid-template-columns:1fr 1fr; gap:10px;">
                ...
                <a href="https://facebook.com/traderabba" class="btn-share btn-blue" style="margin:0;" target="_blank">Facebook</a>
                 <a href="https://youtube.com/@traderabba" class="btn-share btn-blue" style="margin:0;" target="_blank">YouTube</a>
                  <a href="https://t.me/traderabba1" class="btn-share btn-blue" style="margin:0;" target="_blank">Telegram</a>
            </div>
        </div>
...
def shutdown_page_visual():
    ...
    <body><h2 style='color:#0ecb81;'>Configuration Saved</h2><p>Application Terminated.<br>You can close this window.</p></body></html>"""
...
if __name__ == "__main__":
    print(f"\n{'='*60}")
    print("CRYPTO VOLUME ANALYSIS TOOLKIT v3.0 - Standalone Web Version")
    print(f"{'='*60}")
